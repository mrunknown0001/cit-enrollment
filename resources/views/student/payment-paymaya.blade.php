...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Tuition Fee Paymaya Payment</h1>
		<ol class="breadcrumb">
			...
			<div class="col-md-12">
				...
				<div class="box box-danger">
					<div class="box-header with-border">
						<strong><i class="fa fa-credit-card"></i> Tuition Fee Paymaya Payment</strong>
					</div>
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
								...
								<form action="{{ route('student.tuition.fee.paymaya.post') }}" method="POST" autocomplete="off">
									{{ csrf_field() }}
									
									<input type="hidden" name="mop" value="card">
									<input type="hidden" name="currency" value="PHP">
									<input type="hidden" name="name" value="{{ env('app_name') }}">
									<input type="hidden" name="description" value="Tuition Fee Payment using Paymaya">
