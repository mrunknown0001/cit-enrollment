...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<p><a href="{{ route('admin.rooms') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Back to Rooms</a></p>
							...
							<div class="col-md-6">
								<form action="{{ route('admin.add.room.post') }}" method="POST" autocomplete="off">
							      ...
							      <div class="form-group">
							      	<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> Save Room</button>
							      </div>
							    </form>
							</div>
						</div>
