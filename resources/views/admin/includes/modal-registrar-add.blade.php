<div class="modal fade" id="addRegistrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <strong>Add Registrar</strong>
      ...
      <div class="modal-body">
            ...
            <form action="{{ route('admin.add.registrar.post') }}" method="POST" role="form" autocomplete="off">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-danger"><i class="fa fa-plus"></i> Add Registrar</button>
              </div>
            </form>
