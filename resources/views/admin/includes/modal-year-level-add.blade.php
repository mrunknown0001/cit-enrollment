              ...
              <div class="row">
                <div class="col-md-12">
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                      <label for="name">Year Curriculum</label><label class="label-required">*</label>
                      <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Enter Curriculum Name" required>
                      @if ($errors->has('name'))
