<div class="modal fade" id="UpdateSchoolCalendar-{{ $c->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <strong>Update School Calendar</strong>
      ...
      <div class="modal-body">
        ...
        <form action="" method="POST" role="form" autocomplete="off">
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-danger"><i class="fa fa-plus"></i> Update School Calendar</button>
          </div>
        </form>
