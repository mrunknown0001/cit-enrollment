	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				...
				{{-- <p><a href="{{ route('admin.add.registrar') }}" class="btn btn-danger"><i class="fa fa-plus"></i> Add Registrar</a></p> --}}

				<p><button class="btn btn-danger" data-toggle="modal" data-target="#addRegistrar"><i class="fa fa-plus"></i> Add Registrar</button></p>
