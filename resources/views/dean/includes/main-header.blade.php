          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-md-4">
                    <a href="{{ route('dean.profile') }}" class="btn btn-default btn-sm"><i class="fa fa-user"></i> Profile</a>
                  </div>
                  <div class="col-md-8">
                    <a href="{{ route('dean.change.password') }}" class="btn btn-default btn-sm"><i class="fa fa-key"></i> Password Change</a>
                  </div>
                </div>
              </li>
