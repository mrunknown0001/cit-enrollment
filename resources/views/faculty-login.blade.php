...
<head>
  ...
  <title>Faculty Login - Online Enrollment for CIT Colleges of Paniqui Foundation Inc.</title>
...
@include('includes.modal-faculty-login')
<script type="text/javascript">
    $(window).on('load',function(){
        $('#facultyLogin').modal('show');
    });
</script>
<div class="row">
...
{{-- <div class="login-box">
  <div class="login-box-body">
    ...
    <form action="{{ route('faculty.login.post') }}" method="post" autocomplete="off">
      {{ csrf_field() }}
