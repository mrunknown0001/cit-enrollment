...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="row">
			<div class="col-md-12">
				<p>
					<a href="{{ route('registrar.students') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Back to Students</a>
				</p>
				...
				<p><a href="{{ route('registrar.student.educational.info', ['id' => $student->id]) }}" class="btn btn-danger"><i class="fa fa-arrow-right"></i> View Educational Information</a></p>
