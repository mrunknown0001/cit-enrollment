			...
			<div class="col-md-12">
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						...
						<form action="{{ route('registrar.update.student.post') }}" method="POST" autocomplete="off" role="form">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('elementary_school') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="elementary_school" id="elementary_school" value="{{ $student->prev->elementary_school }}" class="form-control" placeholder="Enter Elementary School">
								...
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('elementary_year_graduated') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="elementary_year_graduated" id="elementary_year_graduated" value="{{ $student->prev->elementary_year_graduated }}" class="form-control" placeholder="Enter Elementary Year Graduated">
								...
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('high_school_year_graduated') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="high_school_year_graduated" id="high_school_year_graduated" value="{{ $student->prev->high_school_year_graduated }}" class="form-control" placeholder="Enter High School Year Graduated">
								...
								{{-- <div class="col-md-6">
							      <div class="form-group{{ $errors->has('college') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="college" id="college" value="{{ $student->prev->college_school }}" class="form-control" placeholder="Enter College Degree">
								...
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('college_year_graduated') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="college_year_graduated" id="college_year_graduated" value="{{ $student->prev->college_year_graduated }}" class="form-control" placeholder="Enter College Year Graduated">
								...
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('school_last_attended') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="school_last_attended" id="school_last_attended" value="{{ $student->prev->school_last_attended }}" class="form-control" placeholder="Enter School Last Attended">
								...
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('school_address') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="school_address" id="school_address" value="{{ $student->prev->school_address }}" class="form-control" placeholder="Enter School Address">
								...
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('year_graduated') ? ' has-error' : '' }}">
							      	...
							      	<input type="text" name="year_graduated" id="year_graduated" value="{{ $student->prev->year_graduated }}" class="form-control" placeholder="Enter Last School Year Graduated">
							...
							<div class="form-group">
								<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> Update Student Information</button>
							</div>
						</form>
					</div>
