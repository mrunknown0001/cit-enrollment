			...
			<div class="col-md-12">
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						...
						<form action="{{ route('registrar.add.student.personal.info') }}" method="GET" role="form" autocomplete="off">
							{{ csrf_field() }}
							<div class="row">
								<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
							      <div class="form-group{{ $errors->has('student_number') ? ' has-error' : '' }}">
							        ...
							        <input id="student_number" type="number" class="form-control" name="student_number" value="{{ $sn }}" placeholder="LRN" required>
