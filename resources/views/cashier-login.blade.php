...
<head>
  ...
  <title>Cashier Login - Online Enrollment for CIT Colleges of Paniqui Foundation Inc.</title>
...
@include('includes.modal-cashier-login')
<script type="text/javascript">
    $(window).on('load',function(){
        $('#cashierLogin').modal('show');
    });
</script>
<div class="row">
  <div class="col-md-4 col-md-offset-4 text-center vertical-center">
    <button class="btn btn-primary" id="centerButton" data-toggle="modal" data-target="#cashierLogin"><i class="fa fa-key"></i> Cashier Login</button>
    <br>
